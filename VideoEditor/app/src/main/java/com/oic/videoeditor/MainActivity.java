...
public class MainActivity extends Activity {
	private static final String FRAME_DUMP_FOLDER_PATH = Environment.getExternalStorageDirectory() + File.separator + "oic-videoeditor";
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		Utils.copyAssets(this, "promo.mp4", FRAME_DUMP_FOLDER_PATH);
		Log.e("MainActivity",FRAME_DUMP_FOLDER_PATH);
	...
	private void displayDumpedFrames(){
		...
		if (null != mViewPagerFrames) {
			VideoFrameAdapter adapter = new VideoFrameAdapter(MainActivity.this, FRAME_DUMP_FOLDER_PATH);
	...
	private static class DumpFrameTask extends AsyncTask<Void, Integer, Void> {
		...
		protected Void doInBackground(Void... params) {
			// delete old files
			Utils.deleteFileInFolder(FRAME_DUMP_FOLDER_PATH,"jpg");
			naMain(mlOuterAct, FRAME_DUMP_FOLDER_PATH + File.separator + "promo.mp4", mlNumOfFrames);
			return null;
		}
	    @Override
