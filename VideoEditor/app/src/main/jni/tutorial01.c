...
void SaveFrame(JNIEnv *pEnv, jobject pObj, jobject pBitmap, int width, int height, int iFrame) {
	...
	jclass mainActCls;
	sprintf(szFilename, "/sdcard/oic-videoeditor/frame%d.jpg", iFrame);
...
jint JNI_OnLoad(JavaVM* pVm, void* reserved) {
	...
	nm[0].name = "naMain";
	nm[0].signature = "(Lcom/oic/videoeditor/MainActivity;Ljava/lang/String;I)I";
	nm[0].fnPtr = (void*)naMain;
	jclass cls = (*env)->FindClass(env, "com/oic/videoeditor/MainActivity");
