...
// already defined in tutorial01.c
jint JNI_OnLoad(JavaVM* pVm, void* reserved) {
	...
	jclass cls = (*env)->FindClass(env, "com/oic/videoeditor/tutorial02/MainActivity");
